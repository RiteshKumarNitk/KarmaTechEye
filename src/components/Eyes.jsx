...
const Eyes = () => {
    ...
    return (
        <div className='eyes w-full h-screen overflow-hidden'>
            <div className='w-full relative h-full bg-cover bg-center bg-[url("https://images.pexels.com/photos/5708064/pexels-photo-5708064.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")]'>
